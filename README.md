...
| How to forward messages                       | [ForwardMessagesExample.java](https://github.com/green-api/whatsapp-api-client-java/blob/master/src/main/java/com/greenapi/client/examples/ForwardMessagesExample.java)                               |
| How to send interactive buttons               | [SendInteractiveButtonsExample.java](https://github.com/green-api/whatsapp-api-client-java/blob/master/src/main/java/com/greenapi/client/examples/SendInteractiveButtonsExample.java)                 |
| How to send a typing/recording indicator      | [SendTypingExample.java](https://github.com/green-api/whatsapp-api-client-java/blob/master/src/main/java/com/greenapi/client/examples/SendTypingExample.java)                                         |
| How to get the list of chats                  | [GetChatsExample.java](https://github.com/green-api/whatsapp-api-client-java/blob/master/src/main/java/com/greenapi/client/examples/GetChatsExample.java)                                             |
| How to get incoming and outgoing calls        | [CallsJournalExample.java](https://github.com/green-api/whatsapp-api-client-java/blob/master/src/main/java/com/greenapi/client/examples/CallsJournalExample.java)                                     |
| How to update group settings                  | [UpdateGroupSettingsExample.java](https://github.com/green-api/whatsapp-api-client-java/blob/master/src/main/java/com/greenapi/client/examples/UpdateGroupSettingsExample.java)                       |
| How to use getStateInstanceHistory and updateApiToken | [AccountMethodsExample.java](https://github.com/green-api/whatsapp-api-client-java/blob/master/src/main/java/com/greenapi/client/examples/AccountMethodsExample.java)                         |
| How to delete a status                        | [DeleteStatusExample.java](https://github.com/green-api/whatsapp-api-client-java/blob/master/src/main/java/com/greenapi/client/examples/DeleteStatusExample.java)                                     |
| How to send a message with typing time and custom preview | [SendMessageWithPreviewExample.java](https://github.com/green-api/whatsapp-api-client-java/blob/master/src/main/java/com/greenapi/client/examples/SendMessageWithPreviewExample.java)     |
| How to send a file with typing indicator      | [SendFileWithTypingExample.java](https://github.com/green-api/whatsapp-api-client-java/blob/master/src/main/java/com/greenapi/client/examples/SendFileWithTypingExample.java)                         |
...
| `account.getStateInstanceHistory()`    | The method returns the history of instance state changes                                                                                                     | [GetStateInstanceHistory](https://green-api.com/docs/api/account/GetStateInstanceHistory/)               |
| `account.updateApiToken()`             | The method generates a new API token for the instance                                                                                                        | [UpdateApiToken](https://green-api.com/docs/api/account/UpdateApiToken/)                                 |
...
| `groups.updateGroupSettings()`         | The method updates the group's permission settings (who can send messages, edit group info)                                                                  | [UpdateGroupSettings](https://green-api.com/docs/api/groups/UpdateGroupSettings/)                        |
...
| `journals.lastIncomingCalls()`         | The method returns the last incoming calls of the account                                                                                                    | [LastIncomingCalls](https://green-api.com/docs/api/journals/LastIncomingCalls/)                          |
| `journals.lastOutgoingCalls()`         | The method returns the last outgoing calls of the account                                                                                                    | [LastOutgoingCalls](https://green-api.com/docs/api/journals/LastOutgoingCalls/)                          |
...
| `sending.sendInteractiveButtons()`     | The method sends a message with action buttons (url, call, copy code) to a chat                                                                              | [SendInteractiveButtons](https://green-api.com/docs/api/sending/SendInteractiveButtons/)                 |
| `sending.sendInteractiveButtonsReply()`| The method sends a message with reply buttons to a chat. Beta feature                                                                                        | [SendInteractiveButtonsReply](https://green-api.com/docs/api/sending/SendInteractiveButtonsReply/)       |
...
| `service.editMessage()`                | The method is aimed for editing a text message in a chat                                                                                                     | [EditMessage](https://green-api.com/docs/api/service/EditMessage/)                                       |
| `service.sendTyping()`                 | The method shows a typing or recording indicator to the chat recipient                                                                                       | [SendTyping](https://green-api.com/docs/api/service/SendTyping/)                                         |
| `service.getChats()`                   | The method returns the list of chats for the current account                                                                                                 | [GetChats](https://green-api.com/docs/api/service/GetChats/)                                             |
...
| `statuses.deleteStatus()`                | The method deletes a sent status                                                                                                 | [DeleteStatus](https://green-api.com/docs/api/statuses/DeleteStatus/)                                     |
